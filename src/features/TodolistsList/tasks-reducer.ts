...
import { clearTasksTodos, ClearTasksTodosType } from "Common/Actions/commonActions";
...
const slice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(clearTasksTodos.type, (_state, action: PayloadAction<ClearTasksTodosType>) => {
